  ...
  return (
    <Grid container sx={{ ml: -4 }}>
      ...
      >
        <Toolbar />
        <Box >
          <Outlet context={{ tecnologyData, setTecnologyData, energyCost, setEnergyCost, electVolume, setElectVolume, reePriceEstimation, setReePriceEstimation, date, setDate, dateLast, setDateLast, time0f, setTime0f, time0l, setTime0l, averagePrice, setAveragePrice, solarPVPriceEstimation, setSolarPVPriceEstimation, resultType, setResultType, resultDetails, setResultDetails, energyData, setEnergyData, technologyTypes }} />
        </Box>
      </Box>
    </Grid>
  );
